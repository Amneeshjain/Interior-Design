    ...
    return (
        <section className="bg-white pb-20">
            ...
            <div className="max-w-4xl mx-auto px-5 -mt-16 relative z-10">
                <div className=" bg-white p-8 md:p-12 shadow-2xl border border-orange-100">
                    <p className="text-xl text-gray-700 leading-9 font-light">
                        {blog.description}
                    </p>

                    <div className="w-24 h-[3px] bg-orange-500  my-8"></div>
              ...
              how it works.`}
                    ...
                    <div className="mt-12 flex flex-wrap gap-3">
                        <span className="rounded-full bg-orange-50 px-4 py-2 text-sm text-orange-600">
                            Interior
                        </span>
