...
const Testimonials = () => {
  ...
  return (
    <div className={`${styles.testimonial_main_container} testimonial_main_container`}>
              ...
              <div className={`col-lg-6 ${styles.testiCard}`}>
                ...
                <div className={styles.cardContent}>
                  ...
                  <div className={styles.right}>
                    ...
                    <p>
                      If you are looking for thoroughness and dedicated team to look after your interior needs hire Colonelz for beautifying your house. Their design options are very contemporary and quality is amazing. I have had an amazing experience getting my new house designed by them and it&apos;s been over a year and all the fittings are super sturdy. They are available after the project is delivered and that is one of the major plus and provide peace of mind of house owners. A big thanks to Colonelz team and hope you guys grow with leaps and bounds.
                    </p>
                    <h4>
                      <hr /> Vineet Gautam
                    </h4>
              ...
              <div className={styles.testiCard}>
                ...
                <div className={styles.cardContent}>
                  ...
                  <div className={styles.right}>
                    <h3>&ldquo;They did an amazing work for our home&rdquo;</h3>
                    <p>
                      Colonelz has a unique ability to turn visions into reality. Their team worked closely with me to understand my design preferences and goals, and then brought them to life in the most beautiful and precise way. The creativity, attention to detail, and craftsmanship displayed during my interior design and construction project were truly remarkable. Colonelz&apos;s dedication to their craft and commitment to delivering outstanding results make them the ideal choice for anyone seeking a truly personalized and exceptional design experience.
                    </p>
                    <h4>
                      <hr /> Aditi Singh
                    </h4>
