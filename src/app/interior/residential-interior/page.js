...
const faqData = [
  ...
  {
    question: "2). What services do you offer for Residential Interior Projects?",
    answer:
  ...
  {
    question: "4).How do you ensure my style is reflected in the Residential Interior Design?",
    answer:
...
const page = () => {
  return (
    <div>
      ...
      subtitle="Welcome to Your Dream Home Transformation" text={textData}/>
      </div>
