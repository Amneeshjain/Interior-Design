...
const ProjectGallery = ({ gallery }) => {
  ...
  // Map API images to the required format
  const images = gallery.images.map((src, index) => ({
    id: index + 1,
    src: src,
    thumb: src,
    colSpan: 1,
    rowSpan: index % 3 === 0 ? 3 : 2, // Alternate between rowSpan 3 and 2
  }));
      ...
      <div className={style.image_row}>
        ...
        >
          ...
          >
            ...
            <h2 className="col-lg-12 mt-4 mb-5">{gallery.subheading}</h2>
          </div>
        </div>
