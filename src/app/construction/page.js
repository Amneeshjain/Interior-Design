...
const items = [
  {
    title: "Turnkey ",
    description: "From sketching designs to selecting the final nail, our team handles every aspect of the project. We ensure to offer a seamless journey with our comprehensive approach. "
  },
  {
    title: "Field Expertise ",
    description: "Our experts seamlessly blend creative designs with construction prowess. With this combination, we ensure that your vision is transformed into reality with structural integrity and aesthetics."
  },
  {
    title: "Custom Craftsmanship",
    description: "Our team excels in crafting bespoke elements personalised to your preference. They design spaces with unique features. Ensuring that every inch of it reflects your personality and functional needs.  "
  },
  {
    title: "Budget-Friendly",
    description: "Our integrated design-build approach optimizes resources and eliminates the gap between the designers and builders. With this, we offer you a streamlined process reducing the costs and delay errors. "
  }
];
const textData = [
  {
...
const faqData = [
  ...
  {
    question: "3). What is the typical timeline for completing a Construction Project?",
    answer:
  ...
  {
    question: "4). How do you handle changes or unexpected issues during Construction?",
    answer:
  ...
  {
    question: "5). What should you prepare or provide before starting a Construction Project?",
    answer:
